...
epi_monitoring = [
    Links(**{'to_id': 'uuid:f294e740-9082-46c6-8853-5f095c9b8a28', 'link_def': 'alert_investigation', 'from_date': datetime.datetime(2015, 1, 1, 0, 0), 'to_date': datetime.datetime(2015, 1, 1, 13, 34, 15, 333927), 'data': {'investigator': '4', 'status': 'Confirmed', 'checklist': ['Contact Tracing', 'Referral']}, 'link_value': 'ce934d', 'id': 1}),
    Links(**{'to_id': 'uuid:c793a131-34cc-4d89-a31c-6141b4b949ff', 'link_def': 'alert_investigation', 'from_date': datetime.datetime(2015, 1, 1, 0, 0), 'to_date': datetime.datetime(2015, 1, 1, 15, 50, 37, 708804), 'data': {'investigator': '5', 'status': 'Disregarded', 'checklist': ['Case Management', 'Referral']}, 'link_value': '7f3f68', 'id': 2})
]
