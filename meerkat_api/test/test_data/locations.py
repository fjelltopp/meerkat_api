...
locations = [
    ...
    Locations(**{'clinic_type': 'Primary', 'deviceid': '2', 'case_report': 1, 'geolocation': '0.2,0.2', 'parent_location': 4, 'level': 'clinic', 'name': 'Clinic 2', 'id': 8, 'other': None}),
    ...
    Locations(**{'clinic_type': 'Primary', 'deviceid': '4', 'case_report': 1, 'geolocation': '0.3,0.2', 'parent_location': 5, 'level': 'clinic', 'name': 'Clinic 4', 'id': 10, 'other': None}),
