...
class MeerkatAPITestCase(unittest.TestCase):
    ...
    def test_export_category(self):
        ...
        rv = self.app.get('/export/category/demo_case/cd_tab/cd?variables=[["icd_code", "icd code"], ["icd_name$cd_tab", "Name"], ["code$ale_2,ale_3,ale_4$Confirmed,Disregarded,Ongoing","Alert Status"], ["clinic", "Clinic"], ["meta/instanceID", "uuid"], ["end$month", "Month"], ["end$year", "Year"], ["end$epi_week", "epi_week"]]', headers={"Accept": "text/csv"}, **headers=settings.header})
    ...
    def test_export_forms(self):
        ...
        rv = self.app.get('/export/form/demo_case', headers={"Accept": "text/csv"}, **headers=settings.header})
        ...
        rv = self.app.get('/export/form/demo_case?fields=icd_code,intro./module', headers={"Accept": "text/csv"}, **headers=settings.header})
