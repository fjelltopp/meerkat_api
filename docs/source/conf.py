...
htmlhelp_basename = 'MeerkatAPIdoc'
...
latex_documents = [
    (master_doc, 'MeerkatAPI.tex', 'Meerkat API Documentation',
...
man_pages = [
    (master_doc, 'meerkatapi', 'Meerkat API Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'MeerkatAPI', 'Meerkat API Documentation',
     author, 'MeerkatAPI', 'One line description of project.',
     'Miscellaneous'),
]
